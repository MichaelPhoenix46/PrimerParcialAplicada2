    ...
    <div class="panel-body">
        <div class="form-horizontal col-md-12" role="form">
            ...
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="ValidaID" runat="server" ErrorMessage='El Campo "Cuenta Id" solo acepta numeros' ControlToValidate="CuentaIdTextBox" ValidationExpression="^[0-9]*" Text="*" ForeColor="Red" Display="Dynamic" ToolTip="Entrada no valida" ValidationGroup="Guardar"></asp:RegularExpressionValidator>
                <div class="col-md-1 col-sm-2 col-xs-4">
            ...
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="ValidaBalanceNUM" runat="server" ErrorMessage='El Campo "Balance" solo acepta numeros' ControlToValidate="BalanceTextBox" ValidationExpression="^[0-9]*" Text="*" ForeColor="Red" Display="Dynamic" ToolTip="Entrada no valida" ValidationGroup="Guardar"></asp:RegularExpressionValidator>
